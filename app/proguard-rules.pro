...
-keep class com.paixide.Module.api.**{*;}
-keep class com.paixide.getlist.**{*;}
-keep class com.paixide.IMtencent.**{*;}
-keep class com.tencent.opensource.**{*;}
-keep class com.tencent.liteav.login.**{*;}
-keep class com.paixide.Module.api.**{*;}
-keep class com.paixide.dialog.adapter.**{*;}
