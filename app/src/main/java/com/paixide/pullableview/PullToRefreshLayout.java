    ...
    public void refreshFinish(int refreshResult) {
        ...
        switch (refreshResult) {
            case SUCCEED:
                ...
                refreshStateTextView.setText(R.string.xw_ptr_refresh_succeeded);
            ...
            default:
                // 刷新失败
                refreshStateImageView.setVisibility(View.VISIBLE);
                refreshStateTextView.setText(R.string.xw_ptr_refresh_failed);
    ...
    public void loadmoreFinish(int refreshResult) {
        ...
        switch (refreshResult) {
            case SUCCEED:
                ...
                loadStateTextView.setText(R.string.xw_ptr_load_succeeded);
            ...
            default:
                // 加载失败
                loadStateImageView.setVisibility(View.VISIBLE);
                loadStateTextView.setText(R.string.xw_ptr_load_failed);
    ...
    private void changeState(int to) {
        ...
        switch (state) {
            case INIT:
                ...
                refreshStateTextView.setText(R.string.xw_ptr_pull_to_refresh);
                pullView.clearAnimation();
                pullView.setVisibility(View.VISIBLE);
                // 上拉布局初始状态
                loadStateImageView.setVisibility(View.GONE);
                loadStateTextView.setText(R.string.xw_ptr_pull_up_to_load);
                pullUpView.clearAnimation();
                pullUpView.setVisibility(View.VISIBLE);
                break;
            case RELEASE_TO_REFRESH:
                // 释放刷新状态
                refreshStateTextView.setText(R.string.xw_ptr_release_to_refresh);
            ...
            case REFRESHING:
                ...
                refreshStateTextView.setText(R.string.xw_ptr_refreshing);
                break;
            case RELEASE_TO_LOAD:
                // 释放加载状态
                loadStateTextView.setText(R.string.xw_ptr_release_to_load);
            ...
            case LOADING:
                ...
                loadStateTextView.setText(R.string.xw_ptr_loading);
                break;
            case DONE:
                // 刷新或加载完毕，啥都不做
                break;
