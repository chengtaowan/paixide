...
import com.paixide.Fragment.page1.fragment.one1;
import com.paixide.Fragment.page1.fragment.one2;
import com.paixide.Fragment.page1.fragment.one4;
import com.paixide.Fragment.page1.fragment.one5;
import com.paixide.Fragment.page1.fragment.one6;
import com.paixide.Fragment.page2.fragment.LiveTuivoiceRoom;
import com.paixide.IMtencent.BaseActivity;
import com.paixide.IMtencent.scenes.LiveRoomAnchorActivity;
import com.paixide.IMtencent.scenes.LiveRoomFragment;
import com.paixide.Fragment.page1.fragment.one3;
import com.paixide.Fragment.fragment.Fromnetfollowlist;
import com.paixide.Fragment.page2.fragment.List_fuli_two;
...
import com.paixide.activity.LatestNews.activity_news;
import com.paixide.activity.Memberverify.activity_Namecenter;
import com.paixide.activity.ZYservices.activity_myper;
import com.paixide.activity.Searchactivity.activity_select;
...
public abstract class BasFragment extends Fragment {
    ...
    public List<Fragment> ListFragment() {
        if (fragmentslist.size() == 0) {
            fragmentslist.add(new List_fuli_two());     //采集直播源
            fragmentslist.add(new LiveRoomFragment());  //视频直播源
            fragmentslist.add(new LiveTuivoiceRoom());  //音频直播源
        }
        return fragmentslist;
    }
    ...
    public void tostartActivity(videolist videolist, String play, String imgs, int position) {
        ...
        intent.putExtra(com.paixide.Util.Constants.TITLE, videolist.getTitle());
        intent.putExtra(com.paixide.Util.Constants.PATHVIDEO, play);
        intent.putExtra(com.paixide.Util.Constants.PATHIMG, imgs);
        intent.putExtra(com.paixide.Util.Constants.Edit, false);
        intent.putExtra(com.paixide.utils.Constants.POSITION, position);
        startActivity(intent);
    }
    ...
    public void tostartActivity(videolist videolist, String play, String imgs, int position, boolean showview) {
        ...
        intent.putExtra(com.paixide.Util.Constants.Edit, false);
        intent.putExtra(com.paixide.utils.Constants.POSITION, position);
        intent.putExtra(com.paixide.Util.Constants.showview, showview);
        startActivity(intent);
    }
