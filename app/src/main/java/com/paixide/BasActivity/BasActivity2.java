...
import com.paixide.dialog.dialog_activity_Megsse;
...
public abstract class BasActivity2 extends AppCompatActivity {
    ...
    public void starMainActivity() {
        ...
        intent.setClass(context, userInfo.isAutoLogin() ? com.paixide.activity.Main.MainActivity.class : UserLoginActivity.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
     ...
     * 回调
     */
    public com.paixide.listener.Callback callback = new Callback() {
        @Override
        public void onSuccess() {
    ...
    public void tostartActivity(String title, String play, String imgs, int position) {
        Intent intent = new Intent(context, videoijkplayer0.class);
        intent.putExtra(com.paixide.Util.Constants.TITLE, title);
        intent.putExtra(com.paixide.Util.Constants.PATHVIDEO, play);
        intent.putExtra(com.paixide.Util.Constants.PATHIMG, imgs);
        intent.putExtra(com.paixide.Util.Constants.Edit, false);
        intent.putExtra(com.paixide.utils.Constants.POSITION, position);
