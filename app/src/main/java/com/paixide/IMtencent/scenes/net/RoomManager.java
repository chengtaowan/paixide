package com.paixide.IMtencent.scenes.net;
...
import com.paixide.IMtencent.scenes.adapter.RoomListAdapter;
                        ...
                        public void onCallback(int code, String msg, List<TRTCLiveRoomDef.TRTCLiveRoomInfo> list) {
                            if (code == 0) {
                                ...
                                for (int i = 0, listSize = list.size(); i < listSize; i++) {
                                    ...
                                    scenesRoomInfo.streamUrl = liveRoomInfo.streamUrl;
                                    scenesRoomInfo.roomStatus = liveRoomInfo.roomStatus;
                                    scenesRoomInfo.province=liveRoomInfo.province;
                                    scenesRoomInfo.city=liveRoomInfo.city;
                                    scenesRoomInfo.areacounty=liveRoomInfo.areacounty;
