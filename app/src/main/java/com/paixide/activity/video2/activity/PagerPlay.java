package com.paixide.activity.video2.activity;
...
import com.paixide.Module.onplVideoViewpage;
...
public class PagerPlay extends BasActivity2 implements Mediaplay {
     ...
     * 播放器监听
     */
    private final com.paixide.Module.onplVideoViewpage onplVideoViewpage = new onplVideoViewpage() {
        @Override
