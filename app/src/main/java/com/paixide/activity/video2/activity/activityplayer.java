...
import com.paixide.activity.video.fragmunt.fragment;
...
//            fragments.add(fragmenPlay.show(3));
        ...
        adapter = new setViewPager(getSupportFragmentManager(), fragments, com.paixide.ViewPager.setViewPager.oneindex);
