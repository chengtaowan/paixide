...
public class activity_updateedit extends BasActivity2 implements Paymnets {
    ...
    public void status(int result) {
        ...
        switch (result) {
            case 0:
                startActivityForResult(new Intent(activity, activity_nickname1.class).putExtra(Constants.POSITION, result), config.sussess);
                break;
            case 1:
                //initTimePicker();
                for (int i = 18; i <= 60; i++) {
            ...
            case 2:
                ...
                initTimePicker2(mOptionsItems1, result);
                break;
            case 3:
                //体重
    ...
    private void setItem(personal personal) {
        ...
        mylist.add(userInfo.getName());
        mylist.add(String.valueOf(personal.getAge()));
        mylist.add(String.valueOf(personal.getHeight()));
        mylist.add(String.valueOf(personal.getWeight()));
        mylist.add(personal.getEducation());
        mylist.add(personal.getOccupation());
        mylist.add(personal.getFeeling());
        mylist.add(personal.getPree());
        mylist.add(personal.getPesigntext());
        mylist.add(personal.getCforsds());
        age2.setText("" + personal.getAge2());
        height2.setText("" + personal.getHeight2());
        pesigntext2.setText(TextUtils.isEmpty(personal.getPesigntext2()) ? "" : personal.getPesigntext2());
        List<com.paixide.adapter.Tiktokholder.mysetAdapter.editinfo> list = mysetAdapter.getList();
        for (int i = 0; i < list.size(); i++) {
            com.paixide.adapter.Tiktokholder.mysetAdapter.editinfo editinfo = list.get(i);
    ...
    private Paymnets paymnets = new Paymnets() {
        ...
        public void onSuccess(Object object) {
            setItem((com.tencent.opensource.model.personal) object);
        }
     ...
     * @param options3Items
     */
    private static void dialogoptions(List<String> options1Items, List<List<String>> options2Items, List<List<List<String>>> options3Items, int type) {
