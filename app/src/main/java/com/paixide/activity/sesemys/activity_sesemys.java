...
public class activity_sesemys extends BasActivity2 {
    ...
    public static void user_save_update_Profile(Mesresult mesresult) {
        ...
        userInfo.setUsername(mesresult.getUsername().trim());         //帐号或手机
        userInfo.setMobile(mesresult.getMobile().trim());             //帐号或手机
        userInfo.setPhone(mesresult.getMobile().trim());              //帐号或手机
