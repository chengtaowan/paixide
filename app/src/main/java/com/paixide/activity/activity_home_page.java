...
import com.paixide.Fragment.fragment.fragment_presentation;
import com.paixide.activity.ZYservices.activity_zshouxianming;
...
import com.paixide.dialog.dialog_item_recy_view;
...
public class activity_home_page extends BasActivity2 implements Paymnets {
    ...
    private void sevaluates() {
        ...
        intent.putExtra(com.paixide.utils.Constants.USERID, getuserid);
        startActivity(intent);
    }
