...
import com.paixide.activity.register.activity_rpwd;
import com.paixide.dialog.dialog_Blocked;
import com.paixide.dialog.dialog_Cancellation;
import com.paixide.dialog.dialog_upgrade;
...
public class UserLoginActivity extends BasActivity2 {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            if (loginactivity.getVisibility() == View.GONE) {
