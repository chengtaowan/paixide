package com.paixide.activity.Login;
...
import com.paixide.dialog.dialog_amp_item;
            ...
            switch (tag) {
                ...
                case NetworkUtil.CHECK_TOKEN: {
                    try {
                        ...
                        if (errcode == 0) {
                            NetworkUtil.sendWxAPI(handler, String.format(Webrowse.Chatwxapi, accessToken, openId), NetworkUtil.GET_INFO);
                        } else {
                            //刷新个人资料
                            NetworkUtil.sendWxAPI(handler, String.format(Webrowse.Chatrefresh_token, WXpayObject.APP_ID, refreshToken), NetworkUtil.REFRESH_TOKEN);
                        }
