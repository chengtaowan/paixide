package com.paixide.activity.loadmatching;
...
import com.paixide.activity.loadmatching.adapte.TagCloudViewAdapter;
import com.paixide.activity.loadmatching.model.StarModel;
...
public class activity_Loadmatching extends BasActivity2 {
    ...
    public void iniview() {
        ...
        if (ActivityLocation.checkpermissions(activity)) {
            com.paixide.amap.lbsamap.getmyLocation(callback);
        }
