...
public class Webrowse {
    ...
    //微信分享
    public final static String Sharewchat = BuildConfig.HTTP_WEB + "/index.php/callback.index/Sharewchat";
    //微信支付请求
    public final static String wxapppay = BuildConfig.HTTP_WEB + "/index.php/callback.WechatPay/wxapppay";
    //随机获取1条异常
     ...
     * 微信分享登录
     */
    public final static  String Chatwxapi="https://api.weixin.qq.com/sns/userinfo?access_token=%s&openid=%s";
    /**
     * 微信分享登录
     */
    public final static  String Chatrefresh_token="https://api.weixin.qq.com/sns/oauth2/refresh_token?appid=%s&grant_type=refresh_token&refresh_token=%s";
