...
import com.paixide.dialog.adapter.GiftInfo;
import com.paixide.listener.Callback;
import com.tencent.opensource.model.Socket.data;

import butterknife.BindView;

public class item_caht_07 extends BaseHolder {
    private static final String TAG = item_caht_07.class.getSimpleName();
    @BindView(R.id.icon)
    ImageView icon;
    @BindView(R.id.title)
    TextView title;
    ...
    public item_caht_07(Context content, ViewGroup parent) {
        super(LayoutInflater.from(content).inflate(R.layout.item_chat_07, parent, false));
    }
