...
public class item_caht_04 extends BaseHolder {
    private static final String TAG = item_caht_04.class.getSimpleName();
    @BindView(R.id.icon)
    ImageView icon;
    @BindView(R.id.title)
    TextView title;
    ...
    public item_caht_04(Context content, ViewGroup parent) {
