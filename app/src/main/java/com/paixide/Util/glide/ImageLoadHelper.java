package com.paixide.Util.glide;
...
public class ImageLoadHelper {
     ...
     * glide加载url
     */
    public static void glideShowImageWithUrl(Context context, int url, ImageView imageView) {
        if (!isCanLoadGlideImg(context)) {
            return;
        }
        Glide.with(context).load(url).into(imageView);
     ...
     * glide加载url
     */
    public static void glideShowImageWithUrl(Context context, String url, ImageView imageView, int overWidth, int overHeight) {
        if (!isCanLoadGlideImg(context)) {
            return;
        }
     ...
     * glide圆角加载url,resize
     */
    public static void glideShowCornerImageWithUrl(Context context, String url, ImageView imageView, int cornerDp, int overWidth, int overHeight) {
        if (!isCanLoadGlideImg(context)) {
            return;
        }
        Glide.with(context)
     ...
     * glide圆角加载url,resize
     */
    public static void glideShowCornerImageWithUrl(Context context, int url, ImageView imageView) {
        if (!isCanLoadGlideImg(context)) {
            return;
        }
        Glide.with(context).load(url).transform(new CenterCrop(), new GlideRoundTransform(5)).into(imageView);
     ...
     * glide圆角加载url,resize
     */
    public static void glideShowCornerImageWithUrl(Context context, String url, ImageView imageView,int Radius) {
        if (!isCanLoadGlideImg(context)) {
            return;
        }
        Glide.with(context).load(url).transform(new CenterCrop(), new GlideRoundTransform(Radius)).into(imageView);
    }

    /**
     * glide圆角加载url,resize
     */
    public static void glideShowCornerImageWithUrl(Context context, int url, ImageView imageView,int Radius) {
        if (!isCanLoadGlideImg(context)) {
            return;
        }
        Glide.with(context).load(url).transform(new CenterCrop(), new GlideRoundTransform(Radius)).into(imageView);
     ...
     * glide圆形加载url,resize
     */
    public static void glideShowCircleImageWithUrl(Context context, String url, ImageView imageView, int overWidth, int overHeight) {
        if (!isCanLoadGlideImg(context)) {
            return;
        }
     ...
     * glide加载本地uri,resize
     */
    public static void glideShowImageWithUri(Context context, Uri file, ImageView imageView, int overWidth, int overHeight) {
        if (!isCanLoadGlideImg(context)) {
            return;
        }
     ...
     * glide加载圆形本地uri,resize
     */
    public static void glideShowCircleImageWithUri(Context context, Uri file, ImageView imageView, int overWidth, int overHeight) {
        if (!isCanLoadGlideImg(context)) {
            return;
        }
     ...
     */
    public static void glideShowCornerImageWithUri(Context context, Uri file, ImageView imageView, int cornerDp, int overWidth, int overHeight) {
        if (!isCanLoadGlideImg(context)) {
            return;
        }
        Glide.with(context).load(file).override(overWidth, overHeight).transform(
     ...
     * 高斯模糊
     */
    public static void glideShowImageWithFade(Context context, String url, ImageView imageView, int overWidth, int overHeight) {
        if (!isCanLoadGlideImg(context)) {
            return;
        }
        Glide.with(context)
