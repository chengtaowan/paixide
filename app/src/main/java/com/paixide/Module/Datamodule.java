...
import com.paixide.Module.api.BaseClass;
import com.paixide.Module.api.amainPage;
import com.paixide.Module.api.banner;
import com.paixide.Module.api.buypaymoney;
import com.paixide.Module.api.comment;
import com.paixide.Module.api.goldcoin;
import com.paixide.Module.api.memberparent;
import com.paixide.Module.api.moneylist;
import com.paixide.Module.api.order;
import com.paixide.Module.api.order_moeny;
...
import com.paixide.activity.activity_sevaluate;
import com.paixide.activity.register.activity_reg;
import com.paixide.activity.sesemys.activity_sesemys;
import com.paixide.dialog.dialog_item_view_yhk;
import com.paixide.wxapi.sdk.WXPlay;
...
import com.paixide.utils.AES.Resultinfo;
...
import static com.paixide.Util.Constants.id;
import static com.paixide.getHandler.JsonUitl.stringToList;
...
public class Datamodule<T> {
    ...
    public void login(String user, String pwd, int delelogout, Paymnets paymnets) {
        ...
        PostModule.postModule(Webrowse.memberlogin, requestBody, new Paymnets() {
            @Override
            public void isNetworkAvailable() {
                paymnets.isNetworkAvailable();
            }
                ...
                try {
                    ...
                    if (mesresult.isSuccess()) {
                        ...
                        for (Livevideo livevideo : livevideos) {
                            ...
                            item.type = com.paixide.adapter.setAdapter.two;
                            item.object = rooms;
                            list.add(item);
                        }
                        paymnets.onSuccess(list);
    ...
    public void Retrievepassword(String mobile, String code, Paymnets paymnets) {
        ...
        Map<String, String> map = new HashMap<>();
        map.put(Constants.mobile, mobile.trim());
        map.put(Constants.code, code.trim());
        String path = Webrowse.Retrievepassword + "?" + Webrowse.getMap(map, 3);
    ...
    public void tasklist(int TYPE, Paymnets paymnets) {
        Map<String, String> map = new HashMap<>();
        map.put(com.paixide.utils.Constants.USERID, userInfo.getUserId());
        map.put(com.paixide.utils.Constants.TOKEN, userInfo.getToken());
        map.put(com.paixide.utils.Constants.Page, "1");
        ...
        PostModule.getModule(path, new Paymnets() {
            ...
            public void success(String date) {
                try {
                    Mesresult mesresult = gson.fromJson(date, Mesresult.class);
                    if (mesresult.isSuccess()) {
                        List<banner> banners = JsonUitl.stringToList(mesresult.getData(), banner.class);
    ...
    public void getusername(Paymnets paymnets) {
        ...
        map.put(Constants.USERID, userInfo.getUserId());
        map.put(Constants.Token, userInfo.getToken());
        map.put(Constants.username, userInfo.getPhone());
