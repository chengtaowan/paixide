...
public class GiftController {
    ...
    public View viewPagerItem(final Context context, final int pageIndex, List<GiftInfo> giftInfoList, int columns, int rows) {
        ...
        RecyclerView recyclerView = layout.findViewById(R.id.chart_face_gv);
        ...
        int endIndex = maxPageItems * (pageIndex + 1) > giftInfoList.size() ? giftInfoList.size() : maxPageItems * (pageIndex + 1);
