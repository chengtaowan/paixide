package com.paixide.Fragment.page5;
...
import com.paixide.BasActivity.BaseFrameLayout;
...
import com.paixide.activity.Web.Webviewactivity;
import com.paixide.activity.Withdrawal.References;
import com.paixide.activity.ZYservices.activity_myper;
import com.paixide.activity.activity_chat_settings;
import com.paixide.activity.browse.activity_browse;
import com.paixide.activity.game.Game_Activity_show;
import com.paixide.activity.party.activity_party_list;
import com.paixide.activity.picenter.banner;
import com.paixide.activity.videoalbum.activity_list_Images;
import com.paixide.activity.videoalbum.activity_list_Video;
import com.paixide.activity.picenter.activity_picenter;
import com.paixide.activity.LatestNews.activity_trend;
import com.paixide.activity.edit.activity_updateedit;
import com.paixide.activity.activity_mylikeyou;
import com.paixide.dialog.Dialog_fenxing;
import com.paixide.getHandler.Webrowse;
import com.paixide.widget.Banner;
import com.paixide.widget.fragment_page5;
...
import com.paixide.activity.activity_follow;
import com.paixide.activity.sesemys.activity_sesemys;
import com.paixide.activity.edit.activity_nickname3;
...
public class page5 extends BasFragment {
    ...
    private com.paixide.activity.picenter.banner banner;
    private int nnanner;
    ...
    public void initData() {
        viewpager.setVisibility(View.GONE); //广告暂时关闭上架VOVO
        ...
        datamodule.getdsbanner(2, new Paymnets() {
            ...
            public void onSuccess(Object object) {
                List<com.paixide.Module.api.banner> AdList = (List<com.paixide.Module.api.banner>) object;
                banner2.setVisibility(View.VISIBLE);
                mlist.clear();
                for (com.paixide.Module.api.banner banner1 : AdList) {
