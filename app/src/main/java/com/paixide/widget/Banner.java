...
import com.paixide.IMtencent.chta.ChatActivityMessage;
...
import com.paixide.activity.Image.activity_img_cover;
...
import com.paixide.activity.Withdrawal.activity_balance;
...
import com.paixide.activity.loadmatching.activity_Loadmatching;
import com.paixide.activity.matching.activity_audio_speed;
import com.paixide.activity.party.activity_party_list;
import com.paixide.activity.shareqrcode.activity_Share;
import com.paixide.adapter.Radapter;
import com.paixide.Test.MainActivityshow;
import com.paixide.activity.ZYservices.activity_mycurriculum;
...
import com.paixide.activity.activity_list_column;
...
public class Banner extends BaseFrameLayout implements ViewPager.OnPageChangeListener {
    ...
    public void onWindowFocusChanged(boolean hasWindowFocus) {
        ...
        Log.d(TAG, "onWindowFocusChanged:窗口上的焦点已更改 ");
    }
    ...
    public void getdate() {
        ...
        dot.removeAllViews();
        datamodule.getdsbanner(1,paymnets2);
    }
    ...
    private void viewlist() {
        ...
        if (BuildConfig.TYPE == Constants.TENCENT) {
            ...
            radapter = new Radapter(context, listobj, Radapter.Banner2, paymnets);
            ...
            datamodule.navigation(paymnets);
        }
    }
